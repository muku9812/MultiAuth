    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('jtype.update',$data['row']->id)}}" method='POST'  id="regForm">
                    <input type="hidden" name="_method" value="PUT"/>
                    @csrf
                    @csrf
                    <div class="form-group">
                        <label for="title">Title</label>
                        <input type="text" class="form-control"  name="title" id="title" value="{{$data['row']->name}}" >
                        @error('title')
