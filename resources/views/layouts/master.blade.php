...
<head>
    ...
    <title> Resort | @yield('title')</title>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown user-menu">
                ...
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="{{asset('assets/backend/img/admin.jpg')}}" class="user-image img-circle elevation-2" alt="John Doe">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{route('home')}}" class="brand-link ">
            <img src="{{asset('assets/backend/dist/img/AdminLTELogo.png')}}"
                 ...
                 style="opacity: .8">
            <span class="brand-text font-weight-light">Resort</span>
        </a>
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="{{asset('assets/backend/img/admin.jpg')}}" class="img-circle elevation-2" alt="User Image">
                </div>
                <div class="info">
